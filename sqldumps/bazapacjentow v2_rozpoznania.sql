...
CREATE TABLE `rozpoznania` (
  `Rozp_ID` int(10) NOT NULL AUTO_INCREMENT,
  `ICD_10` varchar(255) DEFAULT NULL,
  `Nazwa rozpoznania` varchar(255) DEFAULT NULL,
  `Roszerzone rozpoznanie` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Rozp_ID`),
  UNIQUE KEY `Roszerzone rozpoznanie_UNIQUE` (`Roszerzone rozpoznanie`)
