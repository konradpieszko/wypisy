...
CREATE TABLE `leki` (
  ...
  `Nazwa_Handlowa` varchar(45) DEFAULT NULL,
  `Substancja_Czynna` varchar(45) DEFAULT NULL,
  `Typowa_Dawka` varchar(45) DEFAULT NULL,
  `Typowe_Dawkowanie` varchar(45) DEFAULT NULL,
  `Firma` varchar(45) DEFAULT NULL,
  `Kategoria` varchar(45) DEFAULT NULL,
  `LekDawka` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Lek_ID`)
